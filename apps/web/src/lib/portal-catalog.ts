...
export const portalGroups: PortalGroupDefinition[] = [
  ...
  },
  {
    id: "field-gateway",
    slug: "field-gateway",
    title: "Field Data Gateway",
    shortTitle: "Field Gateway",
    code: "FG",
    description:
      "Offline-first field capture, device-safe drafts, synchronization, conflict handling, evidence uploads, and submission tracking across HSF programmes and finance.",
    pages: [
      page("Field Gateway Dashboard", "dashboard", "dashboard"),
      page("My Assigned Field Work", "dashboard", "my-work"),
      page("New Field Record", "workflow", "capture"),
      page("Offline Drafts", "workflow"),
      page("Sync Centre", "workflow", "sync-centre"),
      page("Sync Conflicts", "workflow"),
      page("Attachment Queue", "workflow"),
      page("Field Expenses & Bills", "workflow", "field-expenses"),
      page("Programme Activity Capture", "workflow"),
      page("Device & Session Status", "settings"),
      page("Submission Verification Queue", "workflow"),
      page("Field Data Reports", "report"),
    ],
  },
  {
    id: "requisitions",
